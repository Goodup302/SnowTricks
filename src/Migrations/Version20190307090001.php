 ...
 */
final class Version20190307090001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD trick_id INT DEFAULT NULL, ADD thumbnail TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP trick_id, DROP thumbnail');
